...
export default function ProductDetails(props: IProductDetailsProps) {
  ...
  const { data: responseSize, isLoading: isLoadingSize } = useSizes();
  const { data: responseColor, isLoading: isLoadingColor } = useColors();
                    ...
                    <div className="table-responsive text-nowrap">
                      <table className="table table-bordered">
                        ...
                        <tbody>
                          {!isLoadingColor &&
                            responseColor &&
                            responseColor.data.map((color, index) => (
                              <tr key={index}>
                                {color.name}
                                {!isLoadingSize &&
                                  responseSize &&
                                  responseSize.data.map((x, index) => (
                                    <td key={index}>
                                      <FormControl>
                                        <FormControlLabel
                                          control={
                                            <Checkbox
                                              value={x.name + "-" + color.name}
